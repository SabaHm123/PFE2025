package com.pfe.backendpfe.handler;
...
import static com.pfe.backendpfe.handler.BusinessEroorCode.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleException(BadCredentialsException exp) {
        log.error("Erreur d'authentification : {}", exp.getMessage());
        return ResponseEntity
                .status(UNAUTHORIZED)
                .body(
                        ExceptionResponse.builder()
                                ...
                                .error(exp.getMessage()) // Utilisation du message réel
                                .build()
                );
    }
